    ...
    return (
        <div>
            ...
            <div className="row">
                ...
                <div className="col-9">
                    <div className="row" style={{ height: "90vh",background: "linear-gradient(45deg,#F5AAAA,#6EDBFC)" }}>
                        <div className="col-md-6">
                            <div className="d-flex align-items-center justify-content-center" style={{ height: "90vh" }}>
                                <div className="p-5"
                                    style={{ borderRadius: "10px", background: "#E4D2DF", height: "400px", width: "430px", boxShadow: "3px 3px 10px gray" }}>
                                    <h4 className="mb-5 fw-bold text-danger text-center text-uppercase">Profile Picture</h4>
                        ...
                        <div className="col-md-6">
                            <div className="d-flex align-items-center justify-content-center" style={{ height: "90vh" }}>
                                <div className="p-5"
                                    style={{ borderRadius: "10px", background: "#E4D2DF", height: "400px", width: "430px", boxShadow: "3px 3px 10px gray" }}>
                                    <h4 className="mb-5 fw-bold text-danger text-uppercase text-center">Admin Information</h4>
